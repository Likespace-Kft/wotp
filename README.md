# Web crypto One Time Password library
Port of [Node One Time Password library](https://github.com/guyht/wotp) to Web Crypto in order to support Cloudflare Workers platform.
...
var login = await wotp.totp.verify(token, key);
